...
const tripDir = path.basename(path.dirname(currentDir));
const repoRoot = path.resolve(currentDir, "../..");
const outputPath = path.join(repoRoot, tripDir, "route-cache.json");
...
function buildGeneratorUrl() {
  const generatorUrl = new URL(`http://localhost:${port}/${tripDir}/tools/precompute-routes.html`);
